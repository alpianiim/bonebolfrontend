            ...
            <div class="d-flex">
              <div class="col">
                ...
                <div class="mb-3">
                  ...
                  <div class="input-group input-group-sm">
                    <input v-model="userData.namaLengkap" type="text" class="form-control" autocomplete="off" required
                      @input="fullNameValid" @keyup="handleKeyUpText" />
                  </div>
                </div>
                <div class="mb-3">
                  <div class="input-group input-group-sm">
                  ...
                  <div class="input-group input-group-sm">
                    <input v-model="userData.nomorHp" type="text" class="form-control" autocomplete="off" required
                      name="nomorHp" @input="validateNomorHp" @keyup="handleKeyUp" />
